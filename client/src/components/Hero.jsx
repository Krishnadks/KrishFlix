          ...
          <SwiperSlide>
            <div className="relative w-full h-full">
              ...
              <div className="absolute inset-0 flex flex-col md:justify-center justify-end mb-25 md:mb-0 px-6 md:px-16 text-white">
                ...
                <Link to={'/movies'} className="hover:scale-102 mt-5 group px-6 py-2.5 bg-[#f84565]/80 rounded-full w-fit flex items-center justify-center gap-2">
          ...
          <SwiperSlide>
            <div className="relative w-full h-full">
              ...
              <div className="absolute inset-0 flex flex-col md:justify-center justify-end mb-25 md:mb-0 px-6 md:px-16 text-white">
                ...
                <Link to={'/movies'} className=" group hover:scale-102 mt-5 px-6 py-2.5 bg-[#f84565]/80 rounded-full w-fit flex items-center justify-center gap-2">
                  Explore Movies <ArrowRight className="h-4 w-4 mt-0.75 group-hover:translate-x-0.5 transition" />
                </Link>
              </div>
            </div>
          ...
          <SwiperSlide>
            <div className="relative w-full h-full">
              ...
              <div className="absolute inset-0 flex flex-col md:justify-center justify-end mb-25 md:mb-0 px-6 md:px-16 text-white">
                ...
                <Link to={'/movies'} className="hover:scale-102 group mt-5 px-6 py-2.5 bg-[#f84565]/80 rounded-full w-fit flex items-center justify-center gap-2">
                  Explore Movies <ArrowRight className="h-4 w-4 mt-0.75 group-hover:translate-x-0.5 transition" />
                </Link>
              </div>
            </div>
