    ...
    <div className=" w-full bg-[#09090b] py-20 px-6 lg:px-24 xl:px-28 overflow-hidden text-white">
      <div className="relative flex justify-between items-center pt-20">
        ...
        <button
          ...
          className=" z-10 group cursor-pointer flex gap-1"
        >
          View All{" "}
          <ArrowRight className="group-hover:translate-x-0.5 transition h-4 w-4 mt-1" />
        </button>
      </div>
      ...
      <div className="flex justify-center mt-20">
        <button
          ...
          className="px-10 py-3 text-sm bg-[#f84565]/80 font-medium hover:scale-102 cursor-pointer rounded-xl"
        >
          Show more
        </button>
      </div>
